...
var Notifications = function Notifications(_ref) {
  ...
  }, "Subscribe to ", collection_name), /*#__PURE__*/React.createElement("button", {
    type: "button",
    className: "btn-close",
    id: "closeModal",
  ...
  }, "I consent to receiving notifications from ", collection_name, " through email and text, and I acknowledge that I have read and understood the ", ' ', /*#__PURE__*/React.createElement("a", {
    target: "_blank",
  ...
  }, "Your email and phone number are encrypted such that ", collection_name, " will not be able to view them. You can always disable notifications using this widget."), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
  ...
  }, " Click here to get started.")))))))), /*#__PURE__*/React.createElement("button", {
    style: {
      marginTop: '10px'
    },
